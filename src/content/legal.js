...
Цена, порядок продления и налоги показываются до завершения оплаты. Отменить подписку можно в любой момент в портале управления; доступ сохраняется до конца оплаченного периода.
