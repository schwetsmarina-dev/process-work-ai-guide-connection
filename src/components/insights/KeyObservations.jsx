...
const LABELS = {
  ru: {
    ...
    edge: "Край", primary_process: "Первичный процесс", secondary_process: "Вторичный процесс",
  ...
  es: {
    ...
    edge: "Borde", primary_process: "Proceso primario", secondary_process: "Proceso secundario",
