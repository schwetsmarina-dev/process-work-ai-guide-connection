...
const COPY = {
  ...
  en: {
    title: "What my therapist can see",
    intro: "You control access. You can disable it completely or allow each type of information separately.",
    therapist: "Therapist",
    master: "Allow access",
    summaries: "Session summaries",
    summariesHint: "Brief summaries of completed sessions, without sharing the full conversation.",
    insights: "Saved insights",
    insightsHint: "Only insights saved in your library.",
    memory: "My process map",
    memoryHint: "Current semantic hypotheses and changes over time. Individual raw episodes are not shared.",
    map: "Process relationship map",
    mapHint: "Themes, signals, edges, primary and secondary processes, and the relationships between them.",
    risks: "Safety event details",
    risksHint: "If Talvira records a safety event, your therapist will be notified that the event occurred. Without this permission, they will not see the risk type, severity, session content, or other details. Enable this only if you want to allow access to the details.",
  },
  es: {
