...
export default function PracticeLibrary() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12 space-y-6">
      ...
      {isLoading ? <p className="text-sm text-muted-foreground">…</p> : practices.length === 0 ? <p className="text-sm text-muted-foreground">{c.empty}</p> : (
              ...
              <Card key={exercise.id} className="p-5">
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    <h2 className="font-serif text-xl font-semibold">{exercise.title_ru}</h2>
