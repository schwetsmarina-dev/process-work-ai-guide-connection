...
export default function Timeline() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-8 md:py-12">
      <h1 className="font-serif text-3xl font-semibold mb-2">{t("timeline_title", lang)}</h1>
      ...
      <div className="flex items-center gap-5 mb-8 text-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="text-muted-foreground">{t("timeline_sessions", lang)}</span>
        </div>
        <div className="flex items-center gap-2">
          <span className="w-3 h-3 rounded-full bg-chart-3" />
          <Lightbulb className="w-3.5 h-3.5 text-chart-3" />
          <span className="text-muted-foreground">{t("timeline_insights", lang)}</span>
        </div>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16">
          <p className="text-muted-foreground">{t("timeline_empty", lang)}</p>
        </div>
      ) : (
