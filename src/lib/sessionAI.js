...
«Давай начнём» — только в самом первом сообщении сессии. Никогда не повторяй это в середине разговора.
...
✗ «этот образ» — используй конкретное слово: «муж», «фрукт», «камень»
