...
const NEXT_LAYER_INSTRUCTIONS = {
  ...
  immersion:
    "Следующий слой — ИММЕРСИЯ / ПОГРУЖЕНИЕ (обязательный этап перед посланием). " +
    "Процесс ещё не готов к голосу или смыслу — помоги пользователю оставаться внутри опыта. " +
    "Используй ОДИН вопрос погружения, строя его на точных словах пользователя:\n" +
    "• «Что начинает происходить, когда ты остаёшься рядом с этим?»\n" +
    "• «Как меняется твоё состояние?»\n" +
    "• «Что в этом становится сильнее или интенсивнее?»\n" +
    "• «Что начинает разворачиваться внутри этого состояния?»\n" +
    "• «Что ты замечаешь, пока остаёшься рядом с этим?»\n" +
    "• «Что происходит, если не отталкивать это сразу?»\n" +
  ...
  message:
    "Следующий слой — ПОСЛАНИЕ (шаг 6 из 7). " +
    "Пользователь прошёл иммерсию. Теперь спроси: если бы [конкретный объект из сна/тела] мог что-то сказать — что бы это было? " +
...
const SAFE_FALLBACKS = {
  ...
  immersion: "Что начинает происходить, когда ты остаёшься рядом с этим? Как меняется твоё состояние?",
