...
const LAYER_SIGNALS = {
  process_mapping:  ["хочу посмотреть", "интереснее", "более живое", "притягивает", "хочу туда", "хочу глубже", "непривычное", "удивляет", "больше отклика", "больше живости", "куда хочется", "пойти в", "интересно именно", "выбираю", "quiero mirar", "me interesa más", "más vivo", "me atrae", "quiero ir ahí", "quiero profundizar", "poco habitual", "me sorprende", "resuena más", "elijo"],
  localization:     ["в груди", "в животе", "в голове", "в плечах", "в спине", "в горле", "в ногах", "в руках", "в шее", "где-то в", "чувствую в", "en el pecho", "en el abdomen", "en la cabeza", "en los hombros", "en la espalda", "en la garganta", "en las piernas", "en los brazos", "en el cuello", "lo noto en", "lo siento en"],
  emotion:          ["радость", "грусть", "тревог", "страх", "злость", "раздражение", "спокойствие", "апатия", "интерес", "усталость", "пустот", "радост", "приятно", "неприятно", "alegría", "tristeza", "ansiedad", "miedo", "rabia", "enfado", "irritación", "calma", "apatía", "interés", "cansancio", "vacío", "agradable", "desagradable"],
  quality:          ["тяжест", "сжати", "давлени", "пульсац", "вибрац", "твёрд", "мягк", "острое", "тупое", "ноющее", "лёгкость", "peso", "pesadez", "presión", "contracción", "pulsación", "vibración", "duro", "suave", "agudo", "sordo", "ligereza"],
  movement:         ["хочет двигаться", "хочет выйти", "тянет", "толкает", "сжимается", "расширяется", "поднимается", "опускается", "вырваться", "убежать", "остаться", "двигаться", "движение", "quiere moverse", "me tira", "me empuja", "se contrae", "se expande", "sube", "baja", "salir corriendo", "quedarme", "moverme", "movimiento"],
  image:            ["образ", "похоже на", "как будто", "напоминает", "представляю", "вижу", "картина", "существо", "животное", "цвет", "форма", "камень", "каменн", "плита", "вода", "огонь", "свет", "imagen", "parece", "como si", "me recuerda", "imagino", "veo", "criatura", "animal", "color", "forma", "piedra", "agua", "fuego", "luz"],
  message:          ["говорит", "хочет сказать", "послание", "сообщение", "слышу слова", "голос", "шепчет", "кричит", "сказало мне", "dice", "quiere decir", "mensaje", "oigo palabras", "voz", "susurra", "grita", "me dijo"],
  life_connection:  ["в жизни", "в работе", "в отношениях", "сейчас происходит", "похожая ситуация", "это про", "напоминает ситуацию", "узнаю себя", "en mi vida", "en el trabajo", "en mis relaciones", "me pasa ahora", "una situación parecida", "esto tiene que ver con", "me recuerda una situación", "me reconozco"],
  atmosphere:       ["атмосфера", "настроение сна", "ощущение сна", "сон был", "снилось", "тёмный сон", "яркий сон", "atmósfera", "ambiente del sueño", "sensación del sueño", "el sueño era", "sueño oscuro", "sueño luminoso", "sueño intenso"],
  dream_image:      ["видел во сне", "снился", "образ в сне", "персонаж", "место в сне", "фрукт", "фрукты", "дерево", "человек во сне", "vi en el sueño", "apareció en el sueño", "imagen del sueño", "personaje", "lugar del sueño", "árbol", "persona en el sueño"],
  interaction:      ["подошёл", "дотронулся", "поговорил", "взаимодействовал", "приблизился", "попробовал", "пробую", "исследую", "беру", "взял", "трогаю", "касаюсь", "ем", "съел", "нюхаю", "me acerqué", "me acerco", "toqué", "toco", "hablé", "hablo", "interactué", "interactúo", "probé", "pruebo", "exploro", "cojo", "tomé", "huelo"],
  transformation:   ["изменилось", "изменился", "стало", "превратилось", "вкус", "неожиданно", "странно", "удивительно", "другим", "иначе", "трансформация", "внезапно", "cambió", "ha cambiado", "se transformó", "se transforma", "se volvió", "de repente", "inesperado", "inesperada", "extraño", "extraña", "diferente"],
  part_a:           ["одна часть", "часть меня", "с одной стороны", "первая сторона", "una parte", "una parte de mí", "por una parte", "un lado"],
  part_b:           ["другая часть", "другая сторона", "с другой стороны", "вторая часть", "otra parte", "el otro lado", "por otra parte", "por otro lado"],
  // IMMERSION signals — user staying with and unfolding the process
  immersion:        ["что начинает происходить", "остаюсь рядом", "меняется состояние", "становится сильнее", "разворачивается внутри", "переживаю это", "не отталкиваю", "погружаюсь", "остаюсь с этим", "замечаю изменения", "продолжает меняться", "нахожусь внутри", "интенсивнее", "усиливается", "нарастает", "empieza a pasar", "me quedo con", "cambia mi estado", "se hace más fuerte", "se despliega", "lo estoy viviendo", "no lo aparto", "me quedo aquí", "noto cambios", "sigue cambiando", "más intenso", "se intensifica"],
  ...
  integration:      ["я меняюсь", "меняется", "чувствую себя целостн", "чувствую целостн", "я вижу иначе", "стала иначе", "что-то изменилось во мне", "внутри что-то изменилось", "я чувствую зрелость", "чувствую безопасность", "я стала", "я становлюсь", "ощущение целостност", "состояние целостност", "состояние зрелост", "состояние безопасност", "я уже другая", "что-то открылось", "как будто открывается", "появилась ясность", "стало яснее", "я вижу по-другому",
    ...
    "me siento diferente", "algo ha cambiado en mí", "lo veo de otra manera", "me siento más entera", "me siento más entero", "siento claridad", "lo veo más claro", "me siento más tranquila", "me siento más tranquilo", "siento alivio", "me siento más ligera", "me siento más ligero", "siento apoyo", "me siento más segura", "me siento más seguro", "entiendo mejor", "se está aclarando"],
};
