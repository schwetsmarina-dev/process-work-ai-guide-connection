...
const translations = {
  ru: {
    ...
    feedback_insight: "Какой инсайт или важный опыт ты забираешь с собой?",
    ...
    export_pdf_footer: "Talvira · Сгенерировано автоматически",
    ...
    nav_practice_library: "Библиотека практик",
    ...
    node_theme: "Тема",
    node_signal: "Сигнал",
    node_edge: "Край процесса",
    node_primary: "Привычная сторона",
    node_secondary: "Новая/непривычная сторона",
    node_tag: "Тег инсайта",
    node_term: "Термин",
    node_risk: "Сигнал риска",
    ...
    age_hint: "Приложение доступно только совершеннолетним — от 18 лет. Мы спрашиваем только год, дата рождения не сохраняется.",
    ...
    legal_and: "и",
    billing_title: "Подписка",
    billing_beta_title: "Пожизненный доступ",
    billing_beta_text: "Ты пользовалась приложением, когда оно только строилось. Доступ остаётся у тебя навсегда и бесплатно — платить ничего не нужно.",
    billing_paid_lifetime: "У тебя полный доступ без ограничения по времени.",
    billing_paid_until: "Доступ активен до",
    billing_manage: "Управлять подпиской",
    billing_free_text: "Оформи подписку, чтобы открыть полный доступ. Отменить можно в любой момент — доступ сохранится до конца оплаченного периода.",
    billing_subscribe: "Оформить подписку",
    billing_error: "Не удалось открыть страницу оплаты. Попробуй ещё раз или напиши нам.",
    upgrade_quota_title: "Бесплатная сессия в этом режиме уже пройдена",
    upgrade_quota_text: "В пробном доступе — по одной сессии в каждом режиме, чтобы ты могла попробовать все четыре. Подписка открывает неограниченные сессии, резюме, инсайты, отчёты и память между сессиями.",
    upgrade_feature_title: "Это часть подписки",
    upgrade_feature_text: "В пробном доступе открыт сам разговор. Резюме сессий, инсайты, отчёты, карта процесса и память между сессиями входят в подписку.",
    trial_badge: "Пробный доступ",
    trial_left_one: "Осталась 1 бесплатная сессия",
    trial_left_none: "Бесплатная сессия пройдена",
    ...
    auth_reset_success_title: "Пароль изменён",
    auth_reset_success_text: "Теперь можно войти с новым паролем.",
  ...
  es: {
    ...
    feedback_rating: "¿Hasta qué punto te resultó útil esta sesión?",
    feedback_useful: "¿Qué fue lo más útil para ti?",
    feedback_confusing: "¿Qué fue confuso, incómodo o no te encajó?",
    feedback_insight: "¿Qué insight o experiencia importante te llevas contigo?",
    ...
    export_pdf_footer: "Talvira · Generado automáticamente",
    ...
    nav_practice_library: "Biblioteca de prácticas",
    ...
    node_theme: "Tema",
    node_signal: "Señal",
    node_edge: "Borde del proceso",
    node_primary: "Postura habitual",
    node_secondary: "Lado nuevo o emergente",
    node_tag: "Etiqueta de insight",
    node_term: "Término",
    node_risk: "Señal de riesgo",
    ...
    age_hint: "La aplicación está disponible únicamente para personas adultas, a partir de los 18 años. Solo preguntamos el año; no guardamos la fecha de nacimiento.",
    ...
    billing_beta_title: "Acceso de por vida",
    billing_beta_text: "Usaste la aplicación cuando aún se estaba construyendo. Tu acceso es permanente y gratuito — no tienes que pagar nada.",
    billing_paid_lifetime: "Tienes acceso completo sin límite de tiempo.",
    billing_paid_until: "Acceso activo hasta el",
    billing_manage: "Gestionar la suscripción",
    billing_free_text: "Suscríbete para obtener acceso completo. Puedes cancelar cuando quieras y conservarás el acceso hasta el final del periodo pagado.",
    billing_subscribe: "Suscribirme",
    billing_error: "No se ha podido abrir la página de pago. Inténtalo de nuevo o escríbenos.",
    upgrade_quota_title: "Ya has usado la sesión gratuita de este modo",
    upgrade_quota_text: "La prueba incluye una sesión en cada modo, para que puedas probar los cuatro. La suscripción abre sesiones ilimitadas, resúmenes, insights, informes y memoria entre sesiones.",
    upgrade_feature_title: "Esto forma parte de la suscripción",
    upgrade_feature_text: "La prueba incluye la conversación. Los resúmenes, los insights, los informes, el mapa del proceso y la memoria entre sesiones están en la suscripción.",
    trial_badge: "Prueba gratuita",
    trial_left_one: "Te queda 1 sesión gratuita",
    trial_left_none: "Sesión gratuita ya utilizada",
    ...
    auth_reset_success_text: "Ya puedes iniciar sesión con tu nueva contraseña.",
